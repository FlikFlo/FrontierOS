...
const en = {
  ...
  deals: {
    ...
    followup: {
      ...
      body: 'Deal “{title}” moved. When is the next contact?',
      date: 'Date',
      note: 'Note',
      notePlaceholder: 'e.g. Call about pricing',
      skip: 'Skip',
      schedule: 'Schedule',
  ...
  settings: {
    ...
    role: 'Role',
    team: 'Team',
    teamHint: 'Edit names and roles, or remove a member. You can’t change or remove yourself.',
    noMembers: 'No members yet',
    removeMember: 'Remove member',
    removeMemberBody: 'Remove “{name}” from the workspace? They lose all access immediately. Their deals and clients stay, but become unassigned.',
    fullName: 'Full name',
...
const fr: Dictionary = {
  ...
  deals: {
    ...
    nextStep: {
      on: '{date}',
      overdue: 'En retard',
      none: 'Pas de prochaine étape',
    },
    followup: {
      title: 'Planifier la prochaine étape',
      body: 'Affaire « {title} » déplacée. Quand est le prochain contact ?',
      date: 'Date',
      note: 'Note',
      notePlaceholder: 'ex. Rappeler au sujet du prix',
      skip: 'Ignorer',
      schedule: 'Planifier',
  ...
  settings: {
    ...
    role: 'Rôle',
    team: 'Équipe',
    teamHint: 'Modifiez les noms et rôles, ou retirez un membre. Vous ne pouvez pas vous modifier ni vous retirer.',
    noMembers: 'Aucun membre pour l’instant',
    removeMember: 'Retirer le membre',
    removeMemberBody: 'Retirer « {name} » de l’espace de travail ? Il perd immédiatement tout accès. Ses affaires et clients restent, mais deviennent non attribués.',
