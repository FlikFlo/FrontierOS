...
const en = {
  ...
  deals: {
    total: '{count} total',
    columns: { title: 'Deal', client: 'Client', stage: 'Stage', amount: 'Amount', probability: 'Prob.', close: 'Expected close', cases: 'Cases / mo', outlets: 'Outlets' },
...
const fr: Dictionary = {
  ...
  deals: {
    total: '{count} au total',
    columns: { title: 'Affaire', client: 'Client', stage: 'Étape', amount: 'Montant', probability: 'Prob.', close: 'Clôture prévue', cases: 'Caisses / mois', outlets: 'Points de vente' },
